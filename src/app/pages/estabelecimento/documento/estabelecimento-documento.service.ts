...
export class EstabelecimentoDocumentoService extends BaseResourceService<DocumentoOut> {
    ...
    getDocumentoByEstabelecimentoId(
        estabelecimentoId: number
    ): Observable<DocumentoOut[]> {

        const url =
            `${this.apiPath}/por-estabelecimento/${estabelecimentoId}`;
