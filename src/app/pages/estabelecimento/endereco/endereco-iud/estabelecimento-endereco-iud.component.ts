...
@Component({
  selector: 'ngx-estabelecimento-endereco-iud',
  templateUrl: './estabelecimento-endereco-iud.component.html',
  styleUrls: ['./estabelecimento-endereco-iud.component.scss'],
})

export class EstabelecimentoEnderecoIudComponent
  ...
  // Controle do autocomplete de bairro.
  ...
  constructor(
    protected dialogRef: NbDialogRef<EstabelecimentoEnderecoIudComponent>,
  ...
  ngOnInit(): void {
    ...
    if (this.modoEdicao && this.enderecoParaEdicao) {
      const dadosParaFormulario = {
        ...this.enderecoParaEdicao,

        dadosPessoaJuridicaId:
          this.estabelecimentoId ??
          this.enderecoParaEdicao.dadosPessoaJuridicaId,

        tipoEndereco: 'ESTABELECIMENTO',
         principal:
        this.enderecoParaEdicao.principal === 'S' ||
        this.enderecoParaEdicao.principal === 'SIM' ||
        this.enderecoParaEdicao.principal === true,
